...
class SpellDictionary(object):
    ...
    def validate(self, context):
        ...
        self.dictionary = {"hola", "mundo", "bienvenido", "a", "la", "demo"}
        print('A Spanish dictionary has been added')
